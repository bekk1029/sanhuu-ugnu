...
export const AddRecord2 = (props) => {
  ...
  return (
    <div>
      <div
        class="w-[99px] h-8 px-3 bg-blue-600 rounded-[20px] justify-center items-center gap-1 inline-flex cursor-pointer"
          ...
          <div class="self-stretch justify-start items-start inline-flex   ">
            <div class="grow shrink basis-0 px-6 pt-5 pb-6 bg-white flex-col  justify-start items-start gap-5 inline-flex">
              ...
              <div class="self-stretch h-[340px] flex-col justify-start items-start gap-8 flex">
                ...
                <div className="h-10 px-3 rounded-[20px] bg-green-600 justify-center items-center gap-1 inline-flex">
