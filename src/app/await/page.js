...
export default function Await() {
  return (
    <div className="w-full flex h-screen ">
      <div class="w-full h-screen pt-[404px] pb-[436px] bg-white justify-center items-center inline-flex">
            ...
            <div class="w-8 h-8 justify-start items-start inline-flex">
              <div class="w-8 h-8 relative">
                <div role="status">
                  <svg
                    aria-hidden="true"
                    class="w-10 h-10 text-gray-200 animate-spin dark:text-neutral-200 fill-blue-600"
                    viewBox="0 0 100 101"
                    fill="none"
