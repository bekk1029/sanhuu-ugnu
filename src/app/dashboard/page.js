    ...
    <div className=" w-full h-screen ">
      ...
      <div className="max-w-[1400px] m-auto">
        <div className="w-full grid grid-cols-3 gap-6 px-[120px] py-4">
          ...
          <div class="w-full  bg-white rounded-xl flex-col justify-start items-start inline-flex">
        ...
        <div className="w-full grid grid-cols-2 gap-6 px-[120px] py-4">
          <div className="w-full bg-white rounded-xl flex-col justify-start items-start inline-flex">
